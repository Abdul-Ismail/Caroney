...
/*
//0 - 100k
for (let i = 25000; i < 100000 + 25000; i+= 25000) console.log(i)


    //0 - 25k
    for (let i = 6250; i < 25000; i+= 6250) console.log(i)

        //0 - 6250
        for (let i = 0 + 500; i < 6250 + 500; i+= 500) console.log(i)
    ...
    //25k - 50k
    for (let i = 25000 + 6250; i < 50000; i+= 6250) console.log(i)

        //25k - 31250
        for (let i = 25000 + 500; i < 31250 + 500; i+= 500) console.log(i)

        //31250 - 37500
        for (let i = 31250; i < 37500 + 500; i+= 500) console.log(i)

        //37500 - 43750
        for (let i = 37500; i < 43750 + 500; i+= 500) console.log(i)

        //43750 - 50000
        for (let i = 43750; i < 50000 + 500; i+= 500) console.log(i)


    //50k - 75k
    for (let i = 50000 + 6250; i < 75000; i+= 6250) console.log(i)
