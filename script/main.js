...
const predictPrice = async (input) => {
    ...
    while (valueOneFound === false){
        ...
        const data = await JSON.parse(fs.readFileSync('.././generatedTrees/tree_' + valueOne +'.json', 'utf8'))
    ...
    while (valueTwoFound === false){
        ...
        const data = await JSON.parse(fs.readFileSync('.././generatedTrees/tree_' + valueTwo +'.json', 'utf8'))
    ...
    while (priceFound === false){
        ...
        const data = await JSON.parse(fs.readFileSync('.././generatedTrees/tree_' + valueThree +'.json', 'utf8'))
